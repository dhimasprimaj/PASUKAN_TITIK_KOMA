...
import { getRegistrationData } from "./Storage"; // Import fungsi pengambilan data lokal
...
const UpdateMemberList = () => {
  ...
  React.useEffect(() => {
    // Fetch the saved registration data from Storage
    const fetchRegistrationData = async () => {
      try {
        const storedData = await getRegistrationData();
        if (storedData !== null) {
          setMembers([storedData]);
        }
      } catch (e) {
        console.error("Error fetching registration data from Storage: ", e);
      }
    };
  ...
  return (
    <View style={styles.updateMemberList}>
      ...
      <View style={styles.phsquareLightParent}>
        ...
        <View style={[styles.rectangleGroup, styles.rectangleGroupPosition]}>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("UpdateMember")}
          >
      ...
      <View style={styles.search}>
        ...
        <Text style={[styles.listMember, styles.memberTypo]}>List Member</Text>
      </View>
      <Pressable
      ...
      >
        ...
        <Text style={[styles.fitcashier, styles.updateTypo]}>FitCashier</Text>
      </Pressable>
